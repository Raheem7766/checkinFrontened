...
const PassengerForm = ({ passengerNumber, onChange }) => {
  ...
  return (
    <div className="passenger-form">
      <div>
        <div className="w-full h-[74px] flex flex-col md:flex-row items-start md:items-center justify-between px-1">
          <p className="text-[18px] font-semibold text-[#101828] mt-3 lg:mt-0 tracking-[0.4px] mb-2 md:mb-0">
            Passenger {passengerNumber}
            <span className="text-[16px] font-semibold text-[#667085]">
              ( adult )
            </span>
          </p>
          <div className="h-[42px] md:h-[56%] w-full md:w-[32.5%] border border-[#121619] text-[14px] font-normal text-[#121619] tracking-[0.4px] flex items-center justify-center gap-2 rounded-[10px] hover:bg-[#121619] hover:text-white cursor-pointer">
        ...
        <div className="w-full h-full px-1">
          <div className="flex flex-wrap items-center space-x-4 mb-2">
            {["Mr", "Mrs", "Miss"].map((title) => (
              <label key={title} className="flex items-center mb-2 md:mb-0">
                <input
                  type="radio"
