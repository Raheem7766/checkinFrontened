...
export default function ArabPayment({ ...props }) {
          ...
          <div className="w-full bg-[#F2F4F7] h-auto pb-11 px-2 sm:px-4 lg:px-16 pr-4 pt-[22px]">
            <div className="flex flex-col lg:flex-row lg:justify-between gap-4">
              <div className="w-full lg:w-[66.4%]">
                <div className="w-full h-auto lg:h-[65px] shadow-md py-2 lg:py-0 md:py-2 sm:py-2 flex lg:flex-nowrap items-center pl-3 gap-2 mb-[14px] bg-yellow-50 border border-[#121619] rounded-[10px]">
                ...
                <div className="w-full bg-white p-4 shadow-md rounded-[10px] border border-[#D2D2D2]">
              ...
              <div className="w-full lg:w-[31.6%] h-max rounded-[10px] bg-white border border-[#D2D2D2] lg:ml-[14px] pb-4 shadow-md">
                ...
                <p className="text-[12px] lg:text-[14px] font-medium text-[#212529] tracking-[0.3px] pt-1 px-4">
