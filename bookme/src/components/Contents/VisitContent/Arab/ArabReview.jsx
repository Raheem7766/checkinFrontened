...
export default function ArabReview() {
              ...
              <div className="h-full w-full lg:w-[66.5%] px-4 pb-8 bg-white border border-[#D2D2D2] rounded-[10px]">
                ...
                <div className="w-full h-auto px-2 md:px-4 border border-[#D2D2D2] pb-4 rounded-[10px] mt-5 lg:px-6 lg:mt-10 lg:text-[18px]">
                  ...
                  <ul className="text-[12px] px-[10px] pt-[6px] font-semibold text-[#101828] tracking-[0.3px] lg:text-[14px]">
                    <ol>
                      1. Stay in a 1-Bedroom Seaview Suite in Jeddah & Luxury
                      Room in the Makkah Clock Tower{" "}
                    </ol>
                    <ol>2. Dinner Cruise in Jeddah Obhur Bay </ol>
                    <ol>3. Airport Pickup & Drop-off </ol>
                    <ol>4. All Transfers Included </ol>
                    <ol>5. Daily Breakfast Included </ol>
                    <ol>
                      6. Roundtrip Flights from Karachi, Lahore, or Islamabad{" "}
                    </ol>
                    <ol>7. Saudi Visit Visa</ol>
                  </ul>
                  <h2 className="text-[16px] font-medium text-[#212529] mt-2 tracking-[0.3px] lg:text-[18px]">
                    Package Itinerary
                  </h2>
                  <div>
                    ...
                    <div className="w-full flex lg:flex-row gap-4 lg:h-auto mt-4 lg:mt-0">
                      ...
                      <div className="w-full lg:w-[96%] h-auto lg:h-[76%] lg:mt-[14px] px-3 lg:pb-[34px] pt-[10px] border border-[#D2D2D2] rounded-[10px]">
                        ...
                        <ul className="text-[14px] ol pl-[30px] tracking-[0.3px] font-medium text-[#667085]">
                          <li>
                            Al-Balad (Old Town): Tour the UNESCO-listed historic
                            district with its traditional coral architecture
                          </li>
                          <li className="pt-1">
                    ...
                    <div className="w-full flex lg:flex-row gap-4 lg:h-auto mt-4 lg:mt-0">
                      ...
                      <div className="w-full lg:w-[96%] h-auto lg:h-[76%] px-3 lg:pb-[34px] pt-[10px] border border-[#D2D2D2] rounded-[10px]">
                        ...
                        <ul className="text-[14px] ol pl-[30px] tracking-[0.3px] font-medium text-[#667085]">
                          <li>
                            Taif Exploration: Journey to the mountainous city of
                            Taif, known for its scenic views, rose farms, and
                            cooler climate
                          </li>
                          <li className="pt-1">
                            Shubra Palace: Visit this historic palace showcasing
                            traditional Saudi architecture
                          </li>
                          <li className="pt-1">
                            Al Rudaf Park: Relax in this beautiful natural park
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="w-full flex lg:flex-row gap-4 lg:h-auto mt-4 lg:mt-0">
                      ...
                      <div className="w-full lg:w-[96%] h-auto lg:h-[90%] px-3 lg:pb-7 lg:mt-7 pt-[10px] border border-[#D2D2D2] rounded-[10px]">
                        ...
                        <ul className="text-[14px] ol pl-[30px] tracking-[0.3px] font-medium text-[#667085]">
                          ...
                          <li className="pt-1">
                            Umrah Activities: Begin your short Umrah pilgrimage
                            with guidance in Urdu/English
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="w-full flex lg:flex-row gap-4 lg:h-[125px] mt-4 lg:mt-0">
                      ...
                      <div className="w-full lg:w-[96%] h-auto lg:h-[70%] px-3 pt-[10px] border border-[#D2D2D2] rounded-[10px]">
                        ...
                        <ul className="text-[14px] ol pl-[30px] tracking-[0.3px] font-medium text-[#667085]">
                          <li>
                            Return Transfer to Jeddah: Private transfer back to
                            Jeddah for your return flight
                          </li>
                        </ul>
                      </div>
                    </div>
