    ...
    <div className="passenger-form">
      <div className="w-full sm:px-4 lg:px-0">
        <div className="w-full h-auto lg:h-[74px] flex flex-col lg:flex-row items-start lg:items-center justify-between px-1">
          ...
          <div className="w-full lg:h-[56%] lg:w-[32.5%] border border-[#121619] text-[14px] font-normal text-[#121619] tracking-[0.4px] flex items-center justify-center gap-2 rounded-[10px] hover:bg-[#FCEB03] hover:text-[#121619] cursor-pointer py-3 lg:py-0">
