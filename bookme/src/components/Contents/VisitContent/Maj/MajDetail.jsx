  ...
  return (
    <div className="passenger-form">
      <div className="w-full">
        <div className="w-full block lg:h-[74px] lg:flex lg:items-center lg:justify-between px-1">
          <p className="text-[18px] font-semibold text-[#101828] tracking-[0.4px] mb-4 lg:mb-0 mt-2 lg:mt-0">
            Passenger {passengerNumber}
            <span className="text-[16px] font-semibold text-[#667085]">
              ( adult )
            </span>
          </p>
          <div className="w-full lg:h-[56%] lg:w-[32.5%] border border-[#121619] text-[14px] font-normal text-[#121619] tracking-[0.4px] flex items-center justify-center gap-2 rounded-[10px] hover:bg-[#FCEB03] hover:text-[#121619] cursor-pointer">
        ...
        <div className="w-full h-full px-1">
          <div className="flex flex-wrap lg:flex-nowrap lg:items-center lg:space-x-4 mb-2 mt-3 lg:mt-0">
            {["Mr", "Mrs", "Miss"].map((title) => (
              <label key={title} className="flex items-center mr-4 lg:mr-0">
                <input
                  type="radio"
          ...
          <div className="flex flex-col lg:flex-row lg:gap-4 w-full mb-3">
            <div className="w-full mb-3 lg:mb-0 lg:w-[49.5%]">
          ...
          <div className="flex flex-col lg:flex-row lg:gap-4 w-full mb-4">
            <div className="w-full mb-3 lg:mb-0 lg:w-[49.5%]">
          ...
          <div className="flex flex-col lg:flex-row lg:gap-4 w-full mb-2">
            <div className="w-full mb-3 lg:mb-0 lg:w-[49.5%]">
              ...
              <div className="w-full lg:w-[32%] h-max pb-[10px] bg-white px-[10px] pt-3 border border-[#D2D2D2] rounded-[10px]">
                ...
                <div className="flex justify-between pt-[10px]">
                  ...
                  <p className="text-[18px] font-semibold text-[#121619] tracking-[0.10px]">
                    RS {total1.toLocaleString() || "1608000"}
                  </p>
                </div>
              </div>
            </div>
