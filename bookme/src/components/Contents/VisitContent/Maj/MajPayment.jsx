...
export default function MajPayment({ ...props }) {
          ...
          <div className="w-full bg-[#F2F4F7] h-auto pb-11 px-2 sm:px-4 lg:px-16 pr-4 pt-[22px]">
            <div className="flex flex-col lg:flex-row lg:justify-between gap-4">
              <div className="w-full lg:w-[66.4%]">
                <div className="w-full h-auto lg:h-[65px] py-2 lg:py-0 md:py-2 sm:py-2 flex lg:flex-nowrap items-center pl-3 gap-2 mb-[14px] bg-yellow-50 border border-[#FCEB03] rounded-[10px]">
                  <div className="w-max lg:w-[8%] h-[40px] lg:h-[40%] px-2 border-[5px] text-[12px] lg:text-[14px] font-medium text-[#121619] flex items-center justify-center border-[#FCEB03] rounded-full">
                    Note
                  </div>
              ...
              <div className="w-full lg:w-[31.6%] h-max rounded-[10px] bg-white border border-[#D2D2D2] lg:ml-[14px] pb-4 shadow-md">
                <h2 className="text-[16px] lg:text-[18px] font-semibold ml-4 mt-2 leading-snug">
                  7-Day Majestic Riyadh Winter Experience
                </h2>
