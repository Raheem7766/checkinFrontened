...
const PassengerForm = ({ passengerNumber, onChange }) => {
  ...
  return (
    <div className="passenger-form">
      <div>
        <div className="w-full lg:h-[74px] flex flex-col lg:flex-row lg:items-center justify-between px-1">
          <p className="text-[18px] font-semibold text-[#101828] mt-3 lg:mt-0 tracking-[0.4px] mb-4 lg:mb-0">
            Passenger {passengerNumber}
            <span className="text-[16px] font-semibold text-[#667085]">
              ( adult )
            </span>
          </p>
          <div className="w-full lg:w-[32.5%] h-[56%] border border-[#121619] text-[14px] font-normal text-[#121619] tracking-[0.4px] flex items-center justify-center gap-2 rounded-[10px] hover:bg-[#121619] hover:text-white cursor-pointer">
            <MdOutlineDocumentScanner size={17} />
            <p>Scan first page of passport</p>
          </div>
        </div>
        <div className="w-full h-full px-1">
          <div className="flex flex-wrap lg:flex-nowrap items-center space-x-4 mb-2">
