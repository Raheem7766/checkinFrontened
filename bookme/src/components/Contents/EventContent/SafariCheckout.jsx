...
export default function SafariCheckout() {
  const navigate = useNavigate();
  const location = useLocation();
  const { price, counter, selectedDate, count, totalCount, name } =
    location.state || {};
      ...
      <div className="w-full">
        ...
        <div className="w-full pb-10 flex flex-col lg:flex-row bg-[#F2F4F7] px-2 md:px-12">
          ...
          <div className="w-full lg:w-[31.6%] h-max mt-5 rounded-[10px] bg-white border-[1px] border-[#D2D2D2] lg:ml-[14px] pb-4">
            <h2 className="text-lg lg:text-[18px] font-semibold ml-4 mt-2">
              Event
            </h2>
            <p className="text-sm lg:text-[14px] font-medium pl-4 text-[#212529] tracking-[0.3px] pt-1">
              Rawalpindi to Attock Safari Tourist Train
            </p>
            <div className="w-full flex justify-between px-4 pt-2">
              <p className="text-sm lg:text-[14px] font-medium text-[#212529] tracking-[0.3px]">
                Rawalpindi
              </p>
              <p className="text-[#212529] text-sm lg:text-[14px] font-medium">
                {selectedDate}
              </p>
            </div>
            <div className="w-full h-auto pb-4 border-t-[1px] border-b-[1px] mt-4 border-[#D0D5DD]">
              <h2 className="text-lg lg:text-[18px] font-semibold ml-4 mt-2">
                Subtotal
              </h2>
              ...
              {count?.EconomyClass?.count > 0 && (
                <div className="w-full flex justify-between px-4 pt-1">
                  <p className="text-sm lg:text-[14px] font-medium text-[#212529]">
            ...
            <div className="w-full flex justify-between items-center px-4 pl-1 pt-2">
              <h2 className="text-lg lg:text-[18px] font-semibold ml-4">
                Total
              </h2>
              <p className="text-lg lg:text-[18px] font-semibold text-[#121619]">
                Rs {totalPrice}
              </p>
            </div>
          </div>
