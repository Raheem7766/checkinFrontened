...
export default function SafariPayment({ ...props }) {
          ...
          <div className="w-full bg-[#F2F4F7] min-h-[78vh] px-2 sm:px-4 lg:px-[88px] lg:pr-8 pt-6 pb-8">
            <div className="flex flex-col lg:flex-row lg:justify-between gap-4">
              ...
              <div className="w-full lg:w-[32.5%] h-max pb-4 bg-white rounded-[10px] border border-[#D2D2D2]">
                ...
                <div className="flex flex-row justify-between w-full pt-1 pb-4 border-b border-[#D2D2D2] pl-4">
                  <p className="text-[14px] font-medium text-[#212529] lg:w-[48%] tracking-[0.3px]">
                    Railway Station,
                    <br /> Rawalpindi
                  </p>
                  <p className="text-[14px] font-medium text-[#212529] lg:w-[48%] lg:pl-8">
                    Rawalpindi to Attock <br /> Safari Tourist Train
                  </p>
                </div>
                <div className="flex flex-row justify-between px-4 lg:px-0">
                  <h2 className="text-[18px] font-semibold tracking-[0.4px] text-[#101828] lg:pl-4 pt-2">
                    Actual Total
                  </h2>
                  <p className="text-[18px] font-semibold tracking-[0.4px] text-[#101828] lg:pr-4 pt-2">
                    Rs {new Intl.NumberFormat("en-IN").format(total)}
                  </p>
                </div>
                <div className="w-full flex flex-wrap justify-between px-4 pt-[10px]">
                ...
                <div className="flex flex-row justify-between w-full border-t mt-7 border-[#D2D2D2] px-4 lg:pl-4">
                  <h2 className="text-[18px] font-semibold tracking-[0.4px] text-[#101828] pt-2">
                    Total
                  </h2>
                  <p className="text-[18px] font-semibold tracking-[0.4px] text-[#121619] lg:pr-4 pt-2">
