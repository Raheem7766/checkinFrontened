...
export default function BayanCheckout() {
      ...
      <div className="w-full">
        ...
        <div className="w-full pb-10 flex flex-col lg:flex-row bg-[#F2F4F7] px-2 md:px-12">
          ...
          <div className="w-full lg:w-[31.6%] h-max mt-5 rounded-[10px] bg-white border-[1px] border-[#D2D2D2] lg:ml-[14px] pb-4">
            ...
            <div className="w-full flex flex-row justify-between px-4 pt-2">
            ...
            <div className="w-full flex flex-row justify-between items-center px-4 lg:pl-1 pt-2">
              <h2 className="text-[18px] font-semibold lg:ml-4">Total</h2>
