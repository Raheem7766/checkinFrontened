...
export default function DubaiReview() {
  ...
  const handleContinue = () => {
    navigate("/DubaiPayment", { state: { totalPrice, name } });
  };
  return (
    <div>
      <Navbar />
         ...
         <div className="w-full h-max pb-3 bg-white border border-[#D2D2D2] px-3 mt-3 pt-[14px] rounded-[10px]">
            <div className="flex flex-col lg:flex-row gap-5">
              <div className="w-full lg:w-[23.4%] h-[183px]">
                <img
                  src="https://storage.googleapis.com/bookmepk/static/custom/upload/tours/sc-cruise220824.jpg?v1"
                  alt=""
