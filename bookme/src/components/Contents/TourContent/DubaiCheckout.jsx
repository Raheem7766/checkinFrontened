...
export default function DubaiCheckout() {
  ...
  const validateForm = () => {
    const contactValid = Object.entries(formData.contactDetails).every(
      ([key, value]) => {
        if (key === "saveDetails") return true;
        return value.trim() !== "";
      }
    );
  ...
  //     tourName: name,
  //     price: totalPrice,
  //     passengers: Object.entries(formData.passengers).map(([key, details]) => ({
    ...
    <div className="w-full">
      ...
      <div className="w-full pb-10 flex flex-col lg:flex-row bg-[#F2F4F7] px-2 md:px-12">
        <div className="w-full lg:w-[66.2%] h-auto pt-4 lg:pt-[18px] pl-0 lg:pl-[22px]">
          ...
          <div className="mt-6 pb-2 px-3 lg:pl-3 pt-2 rounded-[10px] bg-white border-[1px] border-[#D2D2D2]">
              ...
              Array.from({ length: tickets[type].count }).map((_, i) => {
                ...
                return (
                  <div key={passengerKey}>
                    ...
                    <div className="flex lg:flex-row flex-col gap-4 w-full mt-5 mb-2">
                      <div className="mb-1 w-full lg:w-[31.7%]">
                      ...
                      <div className="mb-1 w-full lg:w-[31.2%]">
                        <label className="block font-medium mb-2">
                          Last Name
                        </label>
                        <input
                      ...
                      <div className="mb-1 w-full lg:w-[31%]">
                        <label className="block font-medium mb-2">
                          Country
                        </label>
                        <select
                    ...
                    <div className="flex lg:flex-row flex-col gap-4 mb-3">
                      <div className="mb-1 w-full lg:w-[23.4%]">
                        <label className="block font-medium mb-2">
                          Date of Birth 
                        </label>
                        <input
                          type="date"
                          value={formData.passengers[passengerKey]?.dob || ""}
                          onChange={(e) =>
                            handlePassengerChange(
                              passengerKey,
                              "dob",
                      ...
                      <div className="mb-1 w-full lg:w-[23.1%]">
                        <label className="block font-medium mb-2">
                          Nationality
                        </label>
                        <select
                          className="w-full outline-none pb-[11px] rounded-md px-3 py-2 border-[1px] border-[#D2D2D2]"
                          value={
                            formData.passengers[passengerKey]?.nationality || ""
                          }
                          onChange={(e) =>
                            handlePassengerChange(
                              passengerKey,
                      ...
                      <div className="mb-1 w-full lg:w-[22.7%]">
                        <label className="block font-medium mb-2">
                          Passport Number
                        </label>
                        <input
                          type="number"
                          value={
                            formData.passengers[passengerKey]?.passportNumber ||
                            ""
                          }
                          onChange={(e) =>
                            handlePassengerChange(
                      ...
                      <div className="mb-1 w-full lg:w-[23.4%]">
                        ...
                        <input
                          type="date"
                          value={
                            formData.passengers[passengerKey]?.expiryDate || ""
                          }
                          onChange={(e) =>
                            handlePassengerChange(
                              passengerKey,
