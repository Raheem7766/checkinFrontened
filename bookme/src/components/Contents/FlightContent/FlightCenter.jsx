...
import img from "../../../images/Moible.png";
...
import Accordion from "../../Home/AccordionItem";
import Footer from "../../Home/Footer";

export default function FlightCenter() {
  ...
  return (
    <div>
      ...
      <div className="container w-full m-auto sm:px-6 lg:px-[80px] wa py-8 lg:py-12">
        <div className="flex flex-col lg:flex-row justify-center items-center rounded-[20px] pt-4 lg:pt-0 pb-6 lg:pb-0 shh">
          ...
          <div className="lg:w-1/2 text-center lg:text-center pt-8 lg:pt-6 py-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-center gap-4 pt-6 lg:pt-9">
              <img
