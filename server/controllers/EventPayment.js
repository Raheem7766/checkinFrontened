...
const PASSWORD = "diokodko";
dotenv.config();

exports.EventcreateCheckoutSession = async (req, res) => {
  try {
...
exports.EventverifyCheckoutSession = async (req, res) => {
  try {
    ...
    if (session.payment_status === "paid") {
      ...
      const booking = await Event.create({
        contactDetails: {
